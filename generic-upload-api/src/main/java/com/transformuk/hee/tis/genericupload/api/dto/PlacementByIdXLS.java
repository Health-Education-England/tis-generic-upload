...
public class PlacementByIdXLS extends TemplateXLS {
  ...
  public String getNationalPostNumber() {
	...
	public boolean equals(Object o) {
		...
		PlacementByIdXLS that = (PlacementByIdXLS) o;
	...
	@Override
	public int hashCode() {
		return Objects.hash(placementId, nationalPostNumber, dateFrom, dateTo, placementType, site, wte, grade, specialty1, specialty2, specialty3, clinicalSupervisor, educationalSupervisor, comments);
	}
