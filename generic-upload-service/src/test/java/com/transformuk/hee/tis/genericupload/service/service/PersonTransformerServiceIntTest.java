...
public class PersonTransformerServiceIntTest {
	...
	@Test
	public void buildsANullQualificationIfFieldsAreNull() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
	...
	@Test
	public void buildsAQualificationIfSomeFieldsAreNotNull() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
		personXLS.setCountryOfQualification(null);
	...
	public QualificationDTO getQualificationDTO(PersonXLS personXLS) throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
		...
		Method m = PersonTransformerService.class.getDeclaredMethod("getQualificationDTO", parameterTypes);
