...
public class PersonTransformerServiceTest {
	...
	public void initialise() {
		...
		programmeDTOS.put(Pair.of(programmeDTO.getProgrammeName(), programmeDTO.getProgrammeNumber()), programmeDTOs);
	...
	public void shouldNotThrowAnExceptionWhenProgrammeNameAndNumberIsNull() {
		ProgrammeDTO programmeDTO = personTransformerService.getProgrammeDTO(null, null, this::getProgrammeDTOByNameAndNumber);
		Assert.assertNull(programmeDTO);
	}

	@Test
	public void shouldNotThrowAnExceptionWhenProgrammeNameAndNumberIsEmpty() {
		ProgrammeDTO programmeDTO = personTransformerService.getProgrammeDTO("", "", this::getProgrammeDTOByNameAndNumber);
		Assert.assertNull(programmeDTO);
	}

	@Test(expected = IllegalArgumentException.class)
	public void shouldThrowAnExceptionWhenProgrammeNumberIsEmpty() {
		personTransformerService.getProgrammeDTO("aProgramme", "", this::getProgrammeDTOByNameAndNumber);
	}

	@Test(expected = IllegalArgumentException.class)
	public void shouldThrowAnExceptionWhenProgrammeNameIsNull() {
		personTransformerService.getProgrammeDTO(null, "aProgramme", this::getProgrammeDTOByNameAndNumber);
	}

	@Test
	public void shouldNotThrowAnExceptionWhenProgrammeNameAndNumberIsValid() {
		ProgrammeDTO programmeDTO = personTransformerService.getProgrammeDTO("A_PROG", "A_PROG_NUM", this::getProgrammeDTOByNameAndNumber);
	...
	public void shouldThrowAnExceptionWhenProgrammeNameAndNumberHasMultiple() {
		...
		programmeDTOS.get(Pair.of(programmeDTODuplicate.getProgrammeName(), programmeDTODuplicate.getProgrammeNumber())).add(programmeDTODuplicate);

		personTransformerService.getProgrammeDTO("A_PROG", "A_PROG_NUM", this::getProgrammeDTOByNameAndNumber);
	}

	@Test(expected = IllegalArgumentException.class)
	public void shouldThrowAnExceptionWhenProgrammeNameAndNumberDoNotMatch() {
		personTransformerService.getProgrammeDTO("B_PROG", "B_PROG_NUM", this::getProgrammeDTOByNameAndNumber);
	}

	@Test
	public void shouldNotThrowAnExceptionWhenCurriculumNameIsNull() {
		CurriculumDTO curriculumDTO = personTransformerService.getCurriculumDTO(null, this::getCurriculumDTOByName);
		Assert.assertNull(curriculumDTO);
	}

	@Test
	public void shouldNotThrowAnExceptionWhenCurriculumNameIsEmpty() {
		CurriculumDTO curriculumDTO = personTransformerService.getCurriculumDTO("", this::getCurriculumDTOByName);
		Assert.assertNull(curriculumDTO);
	}
