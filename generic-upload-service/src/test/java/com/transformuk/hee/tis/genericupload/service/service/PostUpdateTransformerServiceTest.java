...
public class PostUpdateTransformerServiceTest {
    ...
    public void initialiseData() throws Exception {
        ...
        postXLS = createPostXLS("1", specialtyDTO.getName(), anotherSpecialtyDTO.getName(), subSpecialtyDTO.getName());

        postDTO = new PostDTO();
    }

    public PostUpdateXLS createPostXLS(String postId, String specialtyName, String otherSpecialtyName, String subSpecialtyName) {
